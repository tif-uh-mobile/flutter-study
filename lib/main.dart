...
import 'package:tif_flutter/D121201106_Kisana/D121201106_profile_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'My Profil'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        children: const [
          ...
          NavigateButton(name: 'D121201106-Kisana', page: biobio())
        ],
      )),
    );
  }
