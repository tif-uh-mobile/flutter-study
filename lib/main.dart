...
import 'package:tif_flutter/D121201088_FirmansyahJayaKusuma/D121201088_FirmansyahJayaKusuma.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        children: const [
          ...
          NavigateButton(name: 'D121201088_FirmansyahJayaKusuma', page: ProfilFirman())
        ],
      )),
    );
  }
